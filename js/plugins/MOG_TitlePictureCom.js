...
Scene_Title.prototype.create = function () {
	...
	if (String(Moghunter.title_cursorVisible) === "true") {
...
Scene_Title.prototype.createCursorCommand = function () {
	...
	if (String(Moghunter.title_cursorSlide) === "true") {
		this._cursorSlide[3] = true
	};
	this._cursor = new Sprite(ImageManager.loadTitle2_Plug("Cursor")); // Edit here (line changed)
...
Scene_Title.prototype.create_picture_commands = function () {
	...
	for (i = 0; i < this._commandWindow._list.length; i++) {
		this._com_pictures.push(ImageManager.loadTitle2_Plug("Command_" + i)); // Edit here (line changed)
...
Scene_Title.prototype.on_picture_com = function (index) {
	if (TouchInput.x < this._com_pictures_data[index][0]) {
		return false
	};
	if (TouchInput.x > this._com_pictures_data[index][0] + this._com_pictures_data[index][1]) {
		return false
	};
	if (TouchInput.y < this._com_pictures_data[index][2]) {
		return false
	};
	if (TouchInput.y > this._com_pictures_data[index][2] + this._com_pictures_data[index][3]) {
		return false
	};
	return true;
};
...
Scene_Title.prototype.createForeground = function () {
	...
	if (String(Moghunter.title_sprite) === "true") {
...
Scene_Title.prototype.createTitleSprite = function () {
	...
	this._gameTitleSprite = new Sprite(ImageManager.loadTitle2_Plug("Title")); // Edit here (line changed)
