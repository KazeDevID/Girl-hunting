...
Yanfly.BEC.version = 1.47;

//=============================================================================
/*:
 * @plugindesc v1.47 Have more control over the flow of the battle system
...
DataManager.convertSequenceLine = function (obj, line, actionType) {
  ...
  if (line.match(Yanfly.BEC.SeqType6)) {
    ...
    seqArgs = [RegExp.$2, RegExp.$3, RegExp.$4, RegExp.$5, RegExp.$6, RegExp.$7];
